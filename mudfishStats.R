...
# If you have a column like "site 86" to remove, adjust here; if not, skip:
...
for(i in 1:(ncol(datfull)-2)){   # exclude last two columns: forestcover and site
...
# Assign forestcover groups for plotting, matching site order (15 Forested, 15 Reforested)**
...
# PCoA plot without labels (optional)
